...
class HalfKAv2_hm {
    ...
    static constexpr std::array<std::array<IndexType, PIECE_NB>, COLOR_NB> PieceSquareIndex{
...
#define B(v) (v * PS_NB)
    // clang-format off
    static constexpr std::array<IndexType, SQUARE_NB> KingBuckets{
...
#undef B
    ...
    static constexpr std::array<IndexType, SQUARE_NB> OrientTBL{
